                ...
                <div className="max-w-3xl mx-auto px-4">
                    ...
                    <div className="rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all">
                        <p className="text-gray-300 mb-6">
                            ...
                            I specialize in full-stack development, and I'm always eager to learn new technologies and improve my skills.
                            I have experience in various programming languages and frameworks, and I enjoy working on challenging projects that push me to grow as a developer.
                        </p>
                        ...
                        <div className= "p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
                            ...
                            <ul className="list-disc list-inside text-gray-300 space-y-2">
                                <li>
                                    ...
                                    </strong> - Univeristy of Waterloo (2021 - 2026)
                                </li>
